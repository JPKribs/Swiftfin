...
extension EnvironmentValues {
    @Entry
    var filterButtonDimension: CGFloat = 80
}

struct InsetFilterDrawer: View {
    ...
    // Largest letter +4p on either side
    ...
    var body: some View {
        ...
        .environment(\.filterButtonDimension, dimension)
