...
extension UserAdminDetailView {
    struct UserAdminPasswordView: View {
        @EnvironmentObject
        ...
        private var contentView: some View {
            ...
            Section {
                UnmaskSecureField("Confirm New Password", text: $confirmNewPassword) {
                    observer.send(.updatePassword(newPassword: confirmNewPassword))
                }
                .autocorrectionDisabled()
                .textInputAutocapitalization(.none)
            ...
            Section {
                if observer.state == .updating {
                    ...
                    .disabled(newPassword != confirmNewPassword || observer.state == .updating || newPassword == "")
